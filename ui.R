...
shinyUI(fluidPage(
    ...
    sidebarLayout(
        ...
        mainPanel(
            p("This application allows you to compute monthly loan repayment. You have to enter the loan amount, the annual interest rate and the number of years of the loan in the panel on the left side of this page."),
            p("The ouput below shows the monthly repayment amount and the total payment (including the interest). In addition, a breakdown of the amount that will be paid towards the interest and to the principal is shown in graph and tabular format."),
            ...
            p("This application uses the formula from the website", a("http://www.financeformulas.net/Loan_Payment_Formula.html", href="http://www.financeformulas.net/Loan_Payment_Formula.html", target="_blank")),
            ...
            p("The breakdown shows the contribution of the repayment towards principal along with the principal remaining after each repayment. The remaing amount goes to interest. The coloumns and what they contain are:"),
            helpText("year: The year of loan repayment. This will go all the way to the year entered"),
            ...
            helpText("remainingPrincipal: Remaining principal amount that is yet to be paid. ie. What has to be paid to the loan provider, if you were to close the loan at any point."),
            tableOutput("bdown"),
